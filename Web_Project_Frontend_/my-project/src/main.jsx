...
import ProcessPaymentForUser from './components/user/subscriptionManagement/ProcessPaymentForUser.jsx'
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/'> 
      ...
      <Route path='user/addSubscription' element = {<UserLayout Children={<ProcessPaymentForUser/>}/>}/>
